...
\section{Opleidingen}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Stage Thales (2003)}
		  {Samen met een student embbeded software engineering klimaat-simulatiekast 
		  aansturing software geschreven. Mijn rol was het ontwikkelen van de web-interface
		  waar gebruikers via een formulier een test-cyclus kunnen definieren en kunnen
		  uitvoeren. De uitkomst is een rapport met de daadwerktelijk gemeten temperatuur 
		  en relatieve luchtvochtigheid waardes gedurende de test-cyclus.
		  \par
		  Java, JSP, MySQL, Linux
		  }
		\resumeItem{Stage 3e jaars studenten Java laten programmeren (2004)}
...
\section{Ervaring}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{ANWB Fietsknooppuntenplanner (2021)}
		  ...
		  NodeJS ipv Java te implementeren zodat frontend developers er eventueel 
		  ook aan bij kunnen dragen.
		  \par
		  React, Less, Webpack, NodeJS, Apollo GraphQL, Cypress, Turf.js, GitLab, OSRM, Docker,
    ...
    \resumeSubheading
	  ...
	  \par
	  {ICT leverancier voor een verscheidenheid aan klanten. Van bloemenveiling tot advocatenkantoor 
	  en van Stenaline tot particulier. Levert complete ICT inrichting en ontzorgt de klant.}
      \resumeItemListStart
...
\section{Vakkennis}
  \resumeSubHeadingListStart
    \item{
      \textbf{Talen}{: Javascript (ES6), SQL, Java, CSS/Less}
    }
  \resumeSubHeadingListEnd

\resumeSubHeadingListStart
    \item{
      \textbf{Technologi\"{e}n/frameworks}{: React, Webpack, NextJS, NodeJS, Apollo, Elasticsearch, Spring Boot, AWS, Apigee, Redux, Docker, Mendix, MySQL, Postgresql, ExtJS, Magento}
    }
  \resumeSubHeadingListEnd
