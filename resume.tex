...
\resumeSubHeadingListStart
    \item{
      \textbf{Technologi\"{e}n/frameworks}{: React, Webpack, NextJS, NodeJS, Apollo, Elasticsearch, 
	  Spring Boot, AWS, Apigee, Redux, Docker, Mendix, MySQL, Postgresql, ExtJS, Magento}
    }
  \resumeSubHeadingListEnd
